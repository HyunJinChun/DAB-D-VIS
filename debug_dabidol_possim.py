...
"""
파이참 SSH 연결을 통한 코드 디버깅용 파일
-> 학습 시에는 터미널 창에서 "python3 projects/IDOL/train_net_xxx.py ..." 명령어 사용

DAB-IDOL_Base Training Script for code debugging.
...
from projects.DABIDOL_PosSim.dabidol_possim import add_dabidol_possim_config, build_detection_train_loader, build_detection_test_loader
from projects.DABIDOL_PosSim.dabidol_possim.data import (
