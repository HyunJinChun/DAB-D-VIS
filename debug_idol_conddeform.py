...
IDOL Training Script for code debugging.
...
from projects.IDOL_CondDeform.idol_conddeform import add_idol_conddeform_config, build_detection_train_loader, build_detection_test_loader
from projects.IDOL_CondDeform.idol_conddeform.data import (
...
def setup(args):
    ...
    """
    cfg = get_cfg()
    add_idol_conddeform_config(cfg)
