...
from .models.tracker_PosSim import IDOL_Tracker_PosSim
from .util.box_ops import box_cxcywh_to_xyxy, box_xyxy_to_cxcywh
from .util.misc import NestedTensor
from .data.coco import convert_coco_poly_to_mask
import torchvision.ops as ops

__all__ = ["IDOL_CondDeform"]
...
class IDOL_CondDeform(nn.Module):
    """
    Implement IDOL_CondDeform
    """
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            if self.possim:
                idol_tracker = IDOL_Tracker_PosSim(
                    init_score_thr=0.2,
                    obj_score_thr=0.1,
    ...
    def inference(self, outputs, tracker, ori_size, image_sizes):
        ...
        # print('video_dict after tracking :', video_dict)
