...
To train IDOL(ResNet50) on YouTube-VIS 2019 with 3 GPUs , run:

```
python3 projects/IDOL/train_net.py --config-file projects/IDOL/configs/ytvis19_r50.yaml --num-gpus 3 MODEL.WEIGHTS weights/cocopretrain_R50.pth SOLVER.IMS_PER_BATCH 12 
```
...
```
python3 projects/IDOL/train_net.py --config-file projects/IDOL/configs/XXX.yaml --num-gpus 3 --eval-only
```
