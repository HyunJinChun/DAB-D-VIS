...
class IDOL_Tracker(object):
    ...
    def match(self, bboxes, labels, masks, track_feats, frame_id, indices, image_sizes, ori_size):
        ...
        # self.center_dist_thr = ori_size[1] / 2  # Width/2
        # self.center_dist_thr = ori_size[1] / 3  # Width/3
        self.center_dist_thr = math.sqrt(ori_size[0] ** 2 + ori_size[1] ** 2) / 3  # Diagnoal/3
        print('Diagnoal/3')
